...
# 그러면 나중에 탐색하는 사원의 두 번째 점수(b)가 먼저 탐색하는 사원의 두 번째 점수보다 작은 경우가 단 하나라도 있으면 
# 해당 사원보다 두 점수가 높은 사원이 있음이 보장되게 된다.
# 즉, 뒤에 나온 사원의 두 번째 점수가 앞에 나온 어떤 사원의 (max_score2) 보다 크거나 같을 때만 해당 사원은 인센티브 후보가 될 수 있게 된다. 
